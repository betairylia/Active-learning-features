...
init_fn, apply_fn, kernel_fn = stax.serial(
    stax.Dense(hidden_dim, W_std=1.5, b_std=0.05), stax.Erf(),
    stax.Dense(hidden_dim, W_std=1.5, b_std=0.05), stax.Erf(),
    stax.Dense(1)
)
...
predict_fn = nt.predict.gradient_descent_mse_ensemble(kernel_fn, x_tr, y_tr, diag_reg = 3e-4)
